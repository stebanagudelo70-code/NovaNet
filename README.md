📖  NovaNet
es un agente conversacional de atención al cliente para un proveedor de internet (ISP).
Funciona como asesor digital a través de un chat web, integrando soporte técnico, pagos y ventas en un mismo sistema.
